...
/**
 * view the list of games trained by a coach knowing his ID
 *
 */
public class CoachGamesListFragment extends Fragment implements GamesListAdapter.GameClickListener {

    private int mCoachId;
    private RecyclerView mRecyclerView;

    public CoachGamesListFragment() {
    ...
    public void onStart() {
        ...
        Cursor cursor = getContext().getContentResolver().query(ContentUris.withAppendedId(GamesTrainersEntry.CONTENT_URI, (long)mCoachId),null, null,null,null );
        ...
        while (cursor.moveToNext()){
            String gameName = cursor.getString(cursor.getColumnIndex(GamesTrainersEntry.COLUMN_GAME_NAME));
